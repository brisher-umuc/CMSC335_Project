...
public class JobAggregator {
    public JobAggregator(HashMap<Integer, CaveElement> linker, HashMap<Integer, Party> partyLinker, JPanel parent, HashMap<String, ArrayList<String>> jobsHashMap) {
        ...
        for (Map.Entry<String, ArrayList<String>> entry: jobsHashMap.entrySet()) {
            ...
            for (String line: entry.getValue()) {
                Job job = new Job(linker, partyLinker, creaturesJobsPanel, new Scanner(line).useDelimiter("\\s*:\\s*"));
            }
